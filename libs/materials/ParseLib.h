...
constexpr std::pair<const char*, Material::SurfaceType> SurfaceTypeMapping[]
{
	...
	// Prey Surface Types
	{ "wallwalk", Material::SURFTYPE_WALLWALK },
	{ "pipe", Material::SURFTYPE_PIPE },    // Krispy: not sure if this is a surface type or surface flag, but its not used in the game at all.
	{ "matter_altmetal", Material::SURFTYPE_ALTMETAL }
};
...
constexpr std::pair<const char*, Material::SurfaceFlags> SurfaceFlags[]
{
	...
	// Prey Surface Types
	{ "forcefield", Material::SURF_FORCEFIELD },
	{ "spirit", Material::SURF_SPIRIT },
	{ "vehicleclip", Material::SURF_VEHICLECLIP },
	{ "hunterClip", Material::SURF_HUNTERCLIP },
	{ "forcefield_nobullets", Material::SURF_FORCEFIELD },
};
...
constexpr std::pair<const char*, Material::DeformType> DeformTypeNames[]
{
	...
	// Prey Deform Types
	{ "corona", Material::DEFORM_CORONA },
	{ "jitter", Material::DEFORM_JITTER },
	{ "beam", Material::DEFORM_BEAM },
};
