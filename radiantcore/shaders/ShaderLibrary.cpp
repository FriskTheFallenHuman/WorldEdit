...
std::shared_ptr<ShaderTemplate> ShaderLibrary::getTemplate(const std::string& name)
{
	...
	if (auto img = GlobalImageLoader().imageFromVFS(name); img)
	{
		...
		decl->setFileInfo(vfs::FileInfo("materials/", "_autogenerated_by_worldedit_.mtr", vfs::Visibility::HIDDEN));
	...
	decl->setDescription("This material is missing and has been auto-generated by WorldEdit");

	// Make the definition VFS-visible to let them show in MediaBrowser (#5475)
	decl->setFileInfo(vfs::FileInfo("materials/", "_autogenerated_by_worldedit_.mtr", vfs::Visibility::NORMAL));
