...
void XMLRegistry::saveToDisk()
{
	...
	// Replace the version tag and set it to the current WorldEdit version
	...
	// Save the remaining /worldedit/user tree to user.xml so that the current settings are preserved
