...
* coefficients, in WorldEdit, the fourth number in Plane3 is dist, which is -d
...
void LightNode::updateProjection() const
{
	...
	// greebo: Comparing this to the engine sources, all frustum planes in Doom 3
	...
	// Doom 3 uses an array of 6 idPlanes, these relate to WorldEdit like this:
